...
import { Platform, View, ScrollView, Text, StatusBar, SafeAreaView, Image, TouchableHighlight } from 'react-native';
    ...
    mainExample (number, title) {
        ...
        return (
            <View style={styles.exampleContainer}>
               ...
               <View><Text onPress={this.onPressTab} style={styles.tabText}>Trending</Text></View>
               <View><Text style={styles.tabText}>New</Text></View>
               <View><Text style={styles.tabText}>Authentic</Text></View>
               <View><Text style={styles.tabText}>Surprise Me!</Text></View>
               </View>
               </View>
